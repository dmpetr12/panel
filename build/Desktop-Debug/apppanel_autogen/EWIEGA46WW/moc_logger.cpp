...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Logger_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Logger_t qt_meta_stringdata_Logger = {
    {
        QT_MOC_LITERAL(0, 6),  // "Logger"
        QT_MOC_LITERAL(7, 5),  // "write"
        QT_MOC_LITERAL(13, 0),  // ""
        QT_MOC_LITERAL(14, 3)   // "msg"
    },
    "Logger",
    "write",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_Logger[] = {
...
Q_CONSTINIT const QMetaObject Logger::staticMetaObject = { {
    ...
    qt_meta_stringdata_Logger.offsetsAndSizes,
    qt_meta_data_Logger,
    qt_static_metacall,
    nullptr,
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->write((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
