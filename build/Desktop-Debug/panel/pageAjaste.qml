...
настройки"
                        ...
                        MouseArea {
                            anchors.fill: parent
                            onClicked: stackViewList.push("pageAjasteSystem.qml")
                        }
                    }
                    Rectangle {
                        width: 250
...
и времени"
                        ...
                        MouseArea {
                            anchors.fill: parent
                            onClicked: stackViewList.push("pageAjasteTime.qml")
                        }
                    }
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            anchors.fill: parent
                            onClicked: stackViewList.push("pagePassCh.qml")
                        }
                    }
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    MouseArea {
                                        ...
                                        onClicked: {
                                            indexCh= index
                                            showPower = linesModel.line(indexCh) ? linesModel.line(indexCh).mpower : 0
                                            stackViewList.push("pageLineEdit.qml")
                                        }
                                    }
                                }
